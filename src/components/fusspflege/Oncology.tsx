...
export function FusspflegeOncology() {
  return (
    <section className="oncology-bg-reveal bg-mist py-24 lg:py-32">
      ...
      {/* Breite, atmosphärische Bildfläche – orientiert sich am bereits
          vorhandenen full-bleed Bildbereich (AtmospherePhoto.tsx). Kein
          Card-/Bild-neben-Text-Layout, sehr dezentes Creme-Overlay, ruhiges
          Fade-in statt auffälliger Animation. */}
        ...
        <div className="pointer-events-none absolute inset-x-0 bottom-6 sm:bottom-8 lg:bottom-10">
          <div className="mx-auto max-w-6xl px-6 lg:px-10">
            <span className="font-display text-xl text-petrol sm:text-2xl">
              Besondere Lebensphasen brauchen besondere Sorgfalt.
            </span>
      ...
      <div className="mx-auto max-w-6xl px-6 lg:px-10">
        <div className="max-w-2xl">
          <div className="reveal reveal-d4 rounded-sm bg-cream p-8">
            <h3 className="font-display text-2xl text-petrol">
              Was zu dieser besonderen Betreuung gehört
            </h3>
            <ul className="mt-5 flex flex-col gap-2">
              {oncologyTreatment.includes.map((item, index) => (
                <li
                  key={item}
